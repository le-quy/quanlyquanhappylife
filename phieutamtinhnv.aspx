        ...
        <tr>
            <td style="width: 800px">
                ...
                <asp:GridView ID="gvtamtinh" style="margin-left:350px" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="gvtamtinh_SelectedIndexChanged" ForeColor="Black">
                    ...
                    <HeaderStyle BackColor="#FF9900" ForeColor="Blue" />
                </asp:GridView>
                <br />
                ...
                <br />
                <asp:Button ID="btnyctt" runat="server" style="margin-left:350px; margin-top:10px" Width="170px" Text="Yêu cầu thanh toán" Font-Bold="True" Font-Italic="True"  ForeColor="#FF6600" OnClick="btnyctt_Click" />
                 <br />
