...
namespace quan_ly_cafe
{
    public partial class phieutamtinhnv : System.Web.UI.Page
    {
        ...
        protected void btnyctt_Click(object sender, EventArgs e)
        {
            int maban = BANDAO.Instance.maban(lbtenban.Text);
        ...
        protected void btndm_Click(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Có món chưa gửi bếp');location.href='datmonnv.aspx';", true);
                Session.Remove("guibep");
            }
        }
