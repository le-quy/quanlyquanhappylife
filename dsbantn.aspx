        ...
        <table >
            ...
            <tr>
                <td style="text-align:center">
                    ...
                    <asp:Button ID="btnkva" runat="server" style="margin-left: 18px" Text=" A" Width="90" Height="45" BackColor="#FF3300" OnClick="btnkva_Click" Font-Bold="True" ForeColor="White" ></asp:Button>
            ...
            <tr>
                ...
                <td style="text-align:left; width: 200px;" >
                        ...
                        <br />
                        <asp:Button ID="btnchuyenban" style="margin-top: 18px" runat="server" Text="Chuyển bàn" OnClick="btnchuyenban_Click" Width="100" Height="40" ForeColor="Blue" Font-Bold="True" Font-Italic="True"/>
                        <br />
