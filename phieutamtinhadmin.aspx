    ...
    <table style="width:100%;">
        ...
        <tr>
            <td style="width: 800px">
                ...
                <br />
                <asp:Button ID="btntt" runat="server" style="margin-left:350px;margin-top:10px" Text="Yêu cầu thanh toán" OnClick="btntt_Click" Width="160px" Font-Bold="True" Font-Italic="True" ForeColor="#FF6600"  />
                <asp:Button ID="btninhoadon" runat="server" Width="100px" Text="In hóa đơn" Font-Bold="True" Font-Italic="True" OnClick="btninhoadon_Click" />
                <asp:Button ID="btnthanhtoan" runat="server"  Text="Thanh toán" Width="100px"  OnClick="btnthanhtoan_Click" Font-Bold="True" Font-Italic="True" ForeColor="#660066" />
                 <br />
